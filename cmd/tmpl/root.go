...
func initConfig() {
	...
	Author = viper.GetString("main.author")
	Company = viper.GetString("main.company")
	License = viper.GetString("main.license")
	MailAddress = viper.GetString("main.mailaddress")
}
